...
```{r}
## This doesn't show as much, but scales better for wide data sets.
## In this case, it is quite helpful.
glimpse(mpg)
```
...
- This plot aggregates (rolls up) a series of individual rows and GROUPS the results by manufacturer. This is data aggregation.
    - Most of the "data" you see in the news or on the web have gone through a process of data aggregation (and likely other things as well).
    - Because this data lacks SALES, a manufacturer with many models looks "big" compared to a manufacturer with a simple model structure, irrespective of sales.
    - Thus, GM looks huge as does BMW.
